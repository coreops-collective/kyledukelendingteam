...
const STATUSES = ['New Lead','Applied','HOT PA','Nurture PA','REFI Watch','New Contract','Disclosed','Processing','Underwriting','CTC Requested','CTC','BTP','Approved','Funded','Archived'];
